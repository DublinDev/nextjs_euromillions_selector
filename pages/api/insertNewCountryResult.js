...
export default (req, res) => {
    ...
    if (!req.body.country || !COUNTRY_CODES.includes(req.body.country)) {
        throw new Error(`Property "country" must be provided and in the provided list`);
    }
    if (!req.body.numbersMatched) {
        throw new Error(`Property "numbersMatched" must be provided`);
    }
    if (!req.body.countrySpecificWinners || isNaN(req.body.countrySpecificWinners)) {
        throw new Error(`Property "countrySpecificWinners" must be provided`);
    }
